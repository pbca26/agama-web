...
export const LANG_EN = {
  ...
  'CLAIM_INTEREST': {
    'SHOW_ZERO_INTEREST': 'Show zero awards',
    'REQ_P1': 'Requirements to accrue awards',
    'REQ_P2': 'spend transaction was made at least 1 hour ago, locktime field is set and amount is greater than',
    'CLAIM_INTEREST': 'Claim @template@ awards',
    'LOADING': 'Loading awards data',
    'NO_DATA': 'No data',
    'TIP': 'Tip',
    'NOTICE': 'Notice',
    'TIP_DESC': 'don\'t attempt to claim awards smaller than 0.01 KMD. A fee you have to pay for transaction will be more or equal to the awards amount.',
    'NATIVE_INTEREST_CHANGE_DESC': 'It\'s likely that awards are going to be credited as a separate transaction to a newely created KMD address. This is how native implements awards claiming.',
  },
  'ABOUT': {
